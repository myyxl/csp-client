...
#define GS_SOFT_BOARD_CMD_PWROFF                                         6                // 0x0006 bool
...
static const param_table_t gs_soft_board_table[] = {
    ...
    {.name = "cmd_pwroff",    .addr = GS_SOFT_BOARD_CMD_PWROFF,                          .type = PARAM_BOOL,     .size =   1, .count = 1, .flags = 0},
...
#define GS_SOFT_BOARD_TABLE_SIZE                         143 // bytes
...
#define GS_SOFT_BOARD_CMD_PWROFF_SET(value) param_set_bool(GS_SOFT_BOARD_CMD_PWROFF, GS_SOFT_BOARD_TABLE_MEM_ID, value)
#define GS_SOFT_BOARD_CMD_PWROFF_SET_NOCALLBACK(value) param_set_bool_nocallback(GS_SOFT_BOARD_CMD_PWROFF, GS_SOFT_BOARD_TABLE_MEM_ID, value)
#define GS_SOFT_BOARD_CMD_PWROFF_GET() param_get_bool(GS_SOFT_BOARD_CMD_PWROFF, GS_SOFT_BOARD_TABLE_MEM_ID)
