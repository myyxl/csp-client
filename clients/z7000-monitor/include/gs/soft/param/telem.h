...
static const param_table_t gs_soft_telem_table[] = {
    {.name = "coretemp",      .addr = GS_SOFT_TELEM_CORETEMP,                            .type = PARAM_INT16,    .size =   2, .count = 1, .flags = 0},
    {.name = "softadctemp",   .addr = GS_SOFT_TELEM_SOFTADCTEMP,                         .type = PARAM_INT16,    .size =   2, .count = 1, .flags = 0},
    {.name = "femtemp",       .addr = GS_SOFT_TELEM_FEMTEMP(0),                          .type = PARAM_INT16,    .size =   2, .count = 3, .flags = 0},
    {.name = "femadctemp",    .addr = GS_SOFT_TELEM_FEMADCTEMP(0),                       .type = PARAM_INT16,    .size =   2, .count = 3, .flags = 0},
    {.name = "corevcc",       .addr = GS_SOFT_TELEM_COREVCC,                             .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "vccaux",        .addr = GS_SOFT_TELEM_VCCAUX,                              .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "vccbram",       .addr = GS_SOFT_TELEM_VCCBRAM,                             .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "vccpint",       .addr = GS_SOFT_TELEM_VCCPINT,                             .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "vccpaux",       .addr = GS_SOFT_TELEM_VCCPAUX,                             .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "vccoddr",       .addr = GS_SOFT_TELEM_VCCODDR,                             .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "vrefp",         .addr = GS_SOFT_TELEM_VREFP,                               .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "vrefn",         .addr = GS_SOFT_TELEM_VREFN,                               .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "unixtime",      .addr = GS_SOFT_TELEM_UNIXTIME,                            .type = PARAM_UINT64,   .size =   8, .count = 1, .flags = 0},
    {.name = "fem1v3b",       .addr = GS_SOFT_TELEM_FEM1V3B(0),                          .type = PARAM_UINT16,   .size =   2, .count = 3, .flags = 0},
    {.name = "fem-lna1-ma",   .addr = GS_SOFT_TELEM_FEM_LNA1_MA(0),                      .type = PARAM_UINT16,   .size =   2, .count = 3, .flags = 0},
    {.name = "fem-lna2-ma",   .addr = GS_SOFT_TELEM_FEM_LNA2_MA(0),                      .type = PARAM_UINT16,   .size =   2, .count = 3, .flags = 0},
    {.name = "fem1v3ama",     .addr = GS_SOFT_TELEM_FEM1V3AMA(0),                        .type = PARAM_UINT16,   .size =   2, .count = 3, .flags = 0},
    {.name = "fem1v8ma",      .addr = GS_SOFT_TELEM_FEM1V8MA(0),                         .type = PARAM_UINT16,   .size =   2, .count = 3, .flags = 0},
    {.name = "fem1v3a",       .addr = GS_SOFT_TELEM_FEM1V3A(0),                          .type = PARAM_UINT16,   .size =   2, .count = 3, .flags = 0},
    {.name = "fem1v8",        .addr = GS_SOFT_TELEM_FEM1V8(0),                           .type = PARAM_UINT16,   .size =   2, .count = 3, .flags = 0},
    {.name = "fem1v3bma",     .addr = GS_SOFT_TELEM_FEM1V3BMA(0),                        .type = PARAM_UINT16,   .size =   2, .count = 3, .flags = 0},
    {.name = "uptime",        .addr = GS_SOFT_TELEM_UPTIME,                              .type = PARAM_UINT32,   .size =   4, .count = 1, .flags = 0},
    {.name = "loads",         .addr = GS_SOFT_TELEM_LOADS(0),                            .type = PARAM_UINT32,   .size =   4, .count = 3, .flags = 0},
    {.name = "freeram",       .addr = GS_SOFT_TELEM_FREERAM,                             .type = PARAM_UINT32,   .size =   4, .count = 1, .flags = 0},
    {.name = "procs",         .addr = GS_SOFT_TELEM_PROCS,                               .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "ps1v8mw",       .addr = GS_SOFT_TELEM_PS1V8MW,                             .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "ps1vmw",        .addr = GS_SOFT_TELEM_PS1VMW,                              .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "ps3v3mw",       .addr = GS_SOFT_TELEM_PS3V3MW,                             .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "pl1v8mw",       .addr = GS_SOFT_TELEM_PL1V8MW,                             .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "pl1vmw",        .addr = GS_SOFT_TELEM_PL1VMW,                              .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "ram1v35mw",     .addr = GS_SOFT_TELEM_RAM1V35MW,                           .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "pl3v3mw",       .addr = GS_SOFT_TELEM_PL3V3MW,                             .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
    {.name = "boot_count",    .addr = GS_SOFT_TELEM_BOOT_COUNT,                          .type = PARAM_UINT32,   .size =   4, .count = 1, .flags = PARAM_F_PERSIST},
    {.name = "softvin7",      .addr = GS_SOFT_TELEM_SOFTVIN7,                            .type = PARAM_UINT16,   .size =   2, .count = 1, .flags = 0},
};

#define GS_SOFT_TELEM_TABLE_NAME                         "telem"
#define GS_SOFT_TELEM_TABLE_SIZE                         255 // bytes
