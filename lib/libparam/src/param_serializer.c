...
int param_serialize_item_direct(uint16_t addr, param_type_t type, int size, uint8_t * buf, uint16_t * pos, unsigned int maxlen, void * item, param_serializer_flags flags) {
...
int param_serialize_item(const param_table_t * param, uint16_t addr, uint8_t * buf, uint16_t * pos, unsigned int maxlen, void * item, param_serializer_flags flags) {
	...
	return param_serialize_item_direct(addr, type, size, buf, pos, maxlen, item, flags);
}
