...
/* Memory sections */
#ifdef __linux__
/* align to 4 byte boundaries to ensure commands are packed correctly in the commands section */
#define __root_command __attribute__ ((section("commands"), used, aligned(4)))
#else
...
/* Check that size of command_t is multiplum of 4 */
extern int __command_t_size_assert[1-2*!!(sizeof(command_t) % 4)];
